...
<main class="py-12 bg-bg min-h-screen">
    <div class="container mx-auto px-8">
        <header class="text-center mb-12">
            <?php
            the_archive_title('<h1 class="text-3xl font-bold mb-4">', '</h1>');
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-16">
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <article id="post-<?php the_ID(); ?>" class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
